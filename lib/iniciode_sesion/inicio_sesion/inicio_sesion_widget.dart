                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            context
                                                .pushNamed('InicioAplicacion');
                                          },
                                          child: ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(8.0),
                                            child: Image.asset(
                                              'assets/images/7413031.png',
                                              width: 60.0,
                                              height: 60.0,
                                              fit: BoxFit.cover,
                                            ),
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: TabBar(
                                      ...
                                      indicatorColor: const Color(0xFFC7A5FC),
                                      indicatorWeight: 4.0,
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 16.0, 12.0),
                                      tabs: const [
                                                      ...
                                                      child: ClipRRect(
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(8.0),
                                                        child: Image.asset(
                                                          'assets/images/_d294358d-6421-45b8-94a3-d88df60b47ca-removebg-preview.png',
                                                          width: 160.0,
                                                          height: 160.0,
                                                          fit: BoxFit.cover,
                                                        ),
